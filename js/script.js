...
/* [NEW] build data object for template */
  const authorsData = {
    authors: Object.keys(allAuthors).map(name => ({
    name,
    count: allAuthors[name],
  })),
};

/* [NEW] render via Handlebars */
authorList.innerHTML = templates.authorsList(authorsData);
}
